    ...
    render() {
        return (
            <div style={{ paddingLeft: '60px', paddingRight: '60px', paddingBottom: '20px' }}>
                <center>
                    <p></p>
                    <h1>Privacy Policy</h1></center>
                <hr></hr>
                <p>
                    This privacy notice discloses the privacy practices for Online Litigation System. This privacy notice applies solely to information collected by this website.
...
We take precautions to protect your information. When you submit sensitive information via the website, your information is protected both online and offline.<br />
                    ...
                    If you feel that we are not abiding by this privacy policy, you should contact us immediately via email at 15081598-142@uog.edu.pk.
            </p>
            </div>
        )
    }
